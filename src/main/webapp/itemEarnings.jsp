...
try{ 
	...
	String Query = "SELECT SUM(highestBid) FROM auction, listed WHERE auction.ended = 1 AND auction.auctionID = listed.auctionID AND listed.productID = '" + Product + "'";
	rs = st.executeQuery(Query);
	
	while(rs.next()){
		out.print("Total Earnings for Product " + Product + ": $" + rs.getFloat(1));
	}
	%><br><%
