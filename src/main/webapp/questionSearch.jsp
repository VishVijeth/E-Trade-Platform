...
<body>
	...
	try {
		...
		//Fetch search term provided on last page
		String SearchKey = request.getParameter("SearchKey");
		SearchKey = SearchKey.toLowerCase();
		
		while (rs.next()){
			if(rs.getString(2).toLowerCase().contains(SearchKey) || rs.getString(3).toLowerCase().contains(SearchKey)){
		...
		con.close();
		out.print("<a href = 'questionMenu.jsp'>Back to All Questions</a>");
